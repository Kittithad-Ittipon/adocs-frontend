...
// <form className="grid grid-cols-1 w-full p-4 md:px-8 min-h-[750px]">
//   <div className="grid grid-cols-1 xl:grid-cols-2 gap-5 mt-5">
//     <Field className="mb-4 md:mb-0">
//       <FieldLabel htmlFor="input-service-name">Service Name</FieldLabel>
//       <Input
//         id="input-service-name"
//         type="text"
//         className="h-15 shadow-none"
...
//       />
//       <FieldDescription>
//         The internal port your service listens on (e.g., 3000 for Node.js, 80
//         for Nginx).
//       </FieldDescription>
//     </Field>
// <Field className="mb-4 md:mb-0">
...
//   </InputGroup>
//   <FieldDescription>
//     Choose a unique subdomain. Your app will be deployed to this .addp.site
//     address.
//   </FieldDescription>
// </Field>
//     <Field className="mb-4 md:mb-0">
//       <FieldLabel
//         htmlFor="input-deployment-action"
...
//       </span>
//     </HoverCardTrigger>
//     <HoverCardContent className="flex w-75 flex-col gap-3" side="right">
//       <div className="w-full flex flex-col gap-2">
//         <div className="font-[600] text-md">Deploy (New Project)</div>
//         <div className="text-sm font-[300]">
//           Select this to launch a brand-new application. A new container
//           will be created.
//         </div>
//       </div>
//       <div className="w-full flex flex-col gap-2">
...
//           To deploy new code to a running app. <br />
//           <span className="text-amber-500">
//             *Must use the exact same Service Name, Port, and Domain. Only
//             change the .zip file.
//           </span>
//         </div>
//       </div>
//     </HoverCardContent>
//   </HoverCard>
//   Select Deploy for a new project, or Update for an existing one.
// </FieldDescription>
//     </Field>
//   </div>
//   <div className="w-full mt-10 justify-center items-center flex">

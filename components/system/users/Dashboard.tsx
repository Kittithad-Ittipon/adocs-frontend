...
const UserDashboard = () => {
  ...
  const dashboardData = [
    ...
    },
    {
      ...
      href: "/users/logs",
      style:
        "text-2xl font-[800] mt-10 text-cyan-500 hover:text-cyan-600 dark:hover:text-cyan-300 flex items-center gap-2 transition-all",
    },
    {
      title: "phpMyAdmin",
      ...
      style:
        "text-2xl font-[800] mt-10 text-teal-500 hover:text-teal-600 dark:hover:text-teal-300 flex items-center gap-2 transition-all",
    },
    {
      title: "Documents",

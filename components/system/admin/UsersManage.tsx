  ...
  return (
    <div className="max-w-screen min-h-full flex items-center justify-start flex-col">
      ...
      <div className="grid grid-cols-1 w-full p-4 md:px-8">
        ...
        <div
          className={`relative w-full mt-4 rounded-xl overflow-hidden transition-all flex justify-center duration-400 ${isOpen ? "h-[700px] border" : "h-[0px]"}`}
        >
          <div className="w-full h-full overflow-y-auto scrollbar-hide px-12 py-11 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <div
              className={`grid grid-cols-1 w-full h-full transition-colors duration-200 gap-7`}
            >
              <div className="w-full flex flex-col gap-7">
                ...
                <div className="flex flex-col md:flex-row gap-3 md:gap-7 text-sm text-slate-600 dark:text-slate-300">
                  <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col justify-between pb-3">
                <form
                  id="form-edit-users"
                  className="min-h-[200px] flex flex-col gap-2 md:gap-6"
                >
                  <Field className="mb-4 md:mb-0">
                    ...
                    />
                    <FieldDescription>
                      Define the maximum number of containers this user is
                      allowed to deploy (Allowed range: 5 to 10).
                    </FieldDescription>
                  </Field>
                        ...
                        <FieldContent>
                          ...
                          <FieldDescription>
                            ...
                            <span className="text-[12px]">
                              Username: {selectedUsers?.username} <br />
                              Password: password (User can change this password
                              later)
                            </span>
                          </FieldDescription>
                        </FieldContent>
                ...
                <div className="grid grid-cols1 md:grid-cols-2 items-center gap-3 md:gap-6 mt-6 pb-3 md:pb-0">
                  <Button
                    form="form-edit-users"
                    className="shadow-none h-10 md:h-13 bg-black/85 dark:bg-white"
                  >
                    Save Change
                  </Button>
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <Button
                        variant="destructive"
                        className="w-full shadow-none font-[500] dark:bg-red-500 dark:hover:bg-red-700 dark:text-white h-10 md:h-13"
                      >
                        Delete User
                      </Button>
                    </AlertDialogTrigger>
                      ...
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="flex flex-col gap-3 text-left mt-2">
                          ...
                          <span>
                            ...
                            <strong>Domains</strong>, and database data will be
                            permanently wiped from the server.
                          </span>
                        </AlertDialogDescription>
                      </AlertDialogHeader>
